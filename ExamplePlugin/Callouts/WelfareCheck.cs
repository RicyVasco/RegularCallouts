...
namespace RegularCallouts.Callouts
{
    ...
    public class WelfareCheck : Callout
    {
        ...
        private List<string> dialogwithneighbor = new List<string>
        {
            ...
            "~p~Neighbor:~s~ I'm sorry I haven't seen them leave the house in awhile."
        };
        ...
        {
            "~b~Officer:~s~ We have an inconscious individual inside, the person isn't responding.",
        ...
        private void CalloutLos()
        {
            ...
            GameFiber.StartNew(delegate
            {
                ...
                while (WiederDraussen)
                {
                    ...
                    {
                        Game.DisplayHelp("Press ~b~ Y ~s~ to have the medic take the person to the hospital.");
                        if (Game.IsKeyDown(System.Windows.Forms.Keys.Y))
                        {
                            Game.FadeScreenOut(500);
                            GameFiber.Sleep(1000);
        ...
        public override void End()
        {
            ...
            if (MedicBlip.Exists()) MedicBlip.Delete();
        ...
        private void SpawnStuffUnsichtbar()
        {
            GameFiber.StartNew(delegate
            {
                ...
                Feuerwehr1 = new Ped("s_m_y_fireman_01", Feuerwehr1Spawn, 0.0f);
                Feuerwehr2 = new Ped("s_m_y_fireman_01", Feuerwehr2Spawn, 0.0f);
                Polizist = new Ped("s_m_y_cop_01", Polizei1Spawn, 0.0f);
        ...
        /*private void SpawnStuff()
        {
            ...
            {
                SpawnZeug = true;
                Medic2.IsVisible = true; Polizist.IsVisible = true; Feuerwehr1.IsVisible = true; Feuerwehr2.IsVisible = true;
                Medic2.IsCollisionEnabled = true; Polizist.IsCollisionEnabled = true; Feuerwehr1.IsCollisionEnabled = true; Feuerwehr2.IsCollisionEnabled = true;
                Medic2.IsCollisionProof = true; Polizist.IsCollisionEnabled = true; Feuerwehr1.IsCollisionEnabled = true; Feuerwehr2.IsCollisionEnabled = true;
                Medic2.IsPositionFrozen = false; Polizist.IsPositionFrozen = false; Feuerwehr1.IsPositionFrozen = false; Feuerwehr2.IsPositionFrozen = false;
                Krankenwagen.IsVisible = false; Polizei.IsVisible = false; FeuerTruk.IsVisible = false;
                Krankenwagen.IsCollisionEnabled = true; Polizei.IsCollisionEnabled = true; FeuerTruk.IsCollisionEnabled = true;
                Krankenwagen.IsCollisionProof = true; Polizei.IsCollisionEnabled = true; FeuerTruk.IsCollisionEnabled = true;
                Krankenwagen.IsPositionFrozen = false; Polizei.IsPositionFrozen = false; FeuerTruk.IsPositionFrozen = false;
                Polizist.Face(Feuerwehr1);
                Feuerwehr2.Face(Feuerwehr1);
                Feuerwehr1.Face(Polizist);
                SpawnZeug = false;
                MedicBlip = Medic2.AttachBlip();
                MedicBlip.Color = Color.Green;
                WiederDraussen = true;
                return;
            });
        }*/
